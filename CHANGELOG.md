...
- Phase 2 features: Explorer TODO view (Global + Projects), drag-and-drop reordering, scope-aware commands (add/edit/complete/remove/clear) with confirmation + undo flows, and end-to-end localization of runtime prompts.
