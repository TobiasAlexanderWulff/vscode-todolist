...
- Updated developer docs (`README.md`, implementation plan now archived in `docs/archive/implementation-plan.md`, `AGENTS.md`) to describe workflows and the implementation roadmap.
